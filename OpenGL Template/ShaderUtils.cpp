...
{
	ShaderMap.insert(std::make_pair("Player", Utils::createShaderProgram("default.vert", "player.geo", "player.frag")));
	ShaderMap.insert(std::make_pair("Asteroid", Utils::createShaderProgram("asteroid.vert", "asteroid.geo", "asteroid.frag")));
